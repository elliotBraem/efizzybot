...
export const RETRYABLE_ERROR_CODES = [
  'ECONNRESET', 'ETIMEDOUT', 'ECONNREFUSED', 'ENOTFOUND', // Network errors
  '08000', '08003', '08006', '08001', '08004', '57P01',   // PostgreSQL connection errors
  '40001', '40P01',                                       // Serialization/deadlock errors
  '53300', '53400', '55P03', '57014'                      // Resource/query timeout errors
];
...
export async function withErrorHandling<T>(
  ...
  try {
    ...
    throw new Error(errorMessage || `Failed to ${operationName}: ${error.message}`);
  }
}
